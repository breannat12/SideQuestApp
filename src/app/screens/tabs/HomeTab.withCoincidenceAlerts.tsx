// COINCIDENCE FEATURE -- Reference copy of the Home tab from when it rendered CoincidenceSection.
// Held back from v1. Uncomment this file, CoincidenceSection, COINCIDENCE_ALERTS
// in data/friends.ts, and the CoincidenceAlert type to bring the feature back.
